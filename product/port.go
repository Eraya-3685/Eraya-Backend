...
type Service interface {
	...
	GetProducts(ctx context.Context, page, limit int64, search string, categoryIDs []int, sortBy string, minPrice, maxPrice float64) ([]*domain.Product, int64, error)
...
type ProductRepo interface {
	...
	List(ctx context.Context, page, limit int64, search string, categoryIDs []int, sortBy string, minPrice, maxPrice float64) ([]*domain.Product, error)
	Count(ctx context.Context, search string, categoryIDs []int, minPrice, maxPrice float64) (int64, error)
